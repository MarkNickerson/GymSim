...
function gym_input()
  ...
  --player.x += player.dx
  local xoffset = 0
  if player.dx > 0 then xoffset = 3 end
...
function draw_gym()
  ...
  draw_player_small(player.x, player.y, player.moving_right, ismoving)
  draw_boosts()
end
--------------------------------------------------------------------------------
-- end gym
...
function draw_runner()
  ...
  -- spr(1, player.x, player.y)
  draw_player_small(player.x, player.y-8, true, true)
  --debug()
end
...
function draw_masher()
  ...
  if(scratch_left) then
    draw_player_attack(player.x, player.y, true)
  else
    draw_player_attack(player.x, player.y, false)
  end
...
function draw_player_small(x, y, flipped, moving)
  -- draw player sprite 16 x 16
  -- flipped == false (faces left)
  -- flipped == true (faces right)
  if moving and animtimer >5 then
    animtimer = 0
      spr(224, x, y, 2, 2, flipped)
  else
    spr(235, x, y, 2, 2, flipped)
  end
end

function draw_player_attack(x, y, swap)
...
function debug()
  ...
  print (ismoving, player.x + 3, player.y - 11, 9)
end
...

__gff__
...

...

